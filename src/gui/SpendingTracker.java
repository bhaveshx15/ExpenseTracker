...
private final com.toedter.calendar.JDateChooser d;
    /**
    ...
    try {
        // Check if the connection and statement are initialized
        if (db.DbConnect.st != null) {
            ...
            JOptionPane.showMessageDialog(null, "Database statement not initialized!");
            System.err.println("Error: Statement object is null.");
        }
 ...
 "insert into spendings (category,sdate,amount) values('"+
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        JOptionPane.showMessageDialog(null, 
                "Design & Develop BY (Bhavesh Chauhan)");
